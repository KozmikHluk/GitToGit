...
@ECHO OFF
SET REPO_NAME=onboarding
SET GITSERVER=devgit.dev.us.corp
SET PROJ=\\denver2\escrow\ONB\rawexport
SET EXPPATH=e:\e
SET MM=%DATE:~4,2%
SET DD=%DATE:~7,2%
SET YYYY=%DATE:~10,4%
...
git clone ssh://git@%GITSERVER%:7999/onbrd/%REPO_NAME%.git %REPO_NAME%
...
SET P1=\\denver2\escrow\Onb\Release Branches in GIT
