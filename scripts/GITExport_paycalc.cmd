...
SET REPO_NAME=paycalc
SET KEY=CALC
SET PROJ=\\denver2\escrow\%KEY%\rawexport
SET EXPPATH=e:\e
SET MM=%DATE:~4,2%
SET DD=%DATE:~7,2%
SET YYYY=%DATE:~10,4%
...
git clone ssh://git@devgit.dev.us.corp:7999/%KEY%/%REPO_NAME%.git %REPO_NAME%
...
SET P1=\\denver2\escrow\%KEY%\Release Branches in GIT
